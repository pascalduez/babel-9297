...
function _fromElementDescriptor(element) { var obj = { kind: element.kind, key: element.key, placement: element.placement, descriptor: element.descriptor }; var desc = { value: "Descriptor", configurable: true }; (0, _defineProperty.default)(obj, _toStringTag.default, desc); if (element.kind === "field") obj.initializer = element.initializer; return obj; }
...
function _fromClassDescriptor(elements) { var obj = { kind: "class", elements: elements.map(_fromElementDescriptor) }; var desc = { value: "Descriptor", configurable: true }; (0, _defineProperty.default)(obj, _toStringTag.default, desc); return obj; }
...
var Test = _decorate([decorator], function (_initialize) {
